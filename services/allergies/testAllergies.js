...
module.exports = function(db, userId, facilityId) {
    ...
    var observedOne = {
        ...
        "createInput": { // vs createResult
            ...
            "reactions": [
                {
                    "reaction": {"id": "$ID-120_83", "label": "HIVES", "sameAs": "vuid:4538560"}
                },
                {
                    "reaction": {"id": "$ID-120_83", "label": "ITCHING,WATERING EYES", "sameAs": "vuid:4538561"}
                }
            ],
...
// based on a vdm test allergy
    ...
    return {
        ...
        "historicals": { "one": testUtils.fillTemplateValues(db, historicalOne, userId, facilityId), "two": testUtils.fillTemplateValues(db, historicalTwo, userId, facilityId) },

        "observeds": {"one": testUtils.fillTemplateValues(db, observedOne, userId, facilityId), "two": testUtils.fillTemplateValues(db, observedTwo, userId, facilityId) }
