...
# ... todo: put commands into vagrant if needed
...
su $vdpid -c "mkdir fmql"
su $vdpid -c "cp FMQL/webserver/*.j* fmql/."
...
# Add VDM for development
git clone -q https://github.com/vistadataproject/VDM.git
echo "Cloned VDM for development"
