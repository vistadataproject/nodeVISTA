ORWORR1	; SLC/JLI - Utilities for Retrieve Orders for Broker ;3:23 PM  17 Mar 2012
	;;3.0;ORDER ENTRY/RESULTS REPORTING;**141,243,LOCAL**;Dec 17, 1997;Build 3;WorldVistA 30-June-08
	;
	;Called from ORWORR
GET1	;
	...
	. ;was;I $G(ORRECIP)&&($G(FILTER)=12&&($$FLAGRULE(+IFN))) K ^TMP("ORR",$J,ORLIST,I) S TOT=TOT-1 Q
